...
<html>
<head>
    <title>肿瘤患者化疗管理系统-排队因素权重配置</title>
    <style type="text/css">
        .cancer-group {
            width: 100%;
            margin-bottom: 20px;
...
<h3 align="center" style="margin-top:10px;margin-bottom: 10px">排队因素权重配置</h3>
                ...
                <div class="row ">
                    <div class="col-md-6 col-sm-6">
                        <div class="cancer-group row">
                            <label class="pull-left label-lg"><span>*</span>等待天数权重:</label>
                            <div>
                                <input class="easyui-textbox" required="true" type="text" name="waitTimeWeight"
                                       id="waitTimeWeight" value="${config.waitTimeWeight}"/>
                            </div>
                        </div>
                        <div class="cancer-group row">
                            <label class="pull-left label-lg"><span>*</span>病情程度权重:</label>
                            <div>
                                <input class="easyui-textbox" required="true" type="text" name="severityWeight"
                                       id="severityWeight"
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="cancer-group row">
                            <label class="pull-left label-lg"><span>*</span>爽约次数权重:</label>
                            <div>
                                <input class="easyui-textbox" required="true" type="text" name="breakAppointmentWeight"
                                       id="breakAppointmentWeight" value="${config.breakAppointmentWeight}"/>
                            </div>
                        </div>
                    </div>
